...
class _BaseUserSerializer(ModelSerializer):
    """Базовый сериализатор для использования с моделью User."""
...
class CreateUserSerializer(_BaseUserSerializer):
    ...
    class Meta(_BaseUserSerializer.Meta):
        fields = _BaseUserSerializer.Meta.fields + ("password",)
...
class UserSerializer(_BaseUserSerializer):
    ...
    class Meta(_BaseUserSerializer.Meta):
        fields = _BaseUserSerializer.Meta.fields + ("is_subscribed",)
        read_only_fields = ("__all__",)
